...
class TestAuth(BaseCase):
    ...
    def test_need_authenticate(self, index_page, driver):
        ...
        WebDriverWait(driver, 10).until(EC.url_contains(Config.VK_ID_URL))
    ...
    def test_already_authenticated(self, authorized_user, driver):
        ...
        # если ЛК не создан
        WebDriverWait(driver, 10).until(lambda d: d.current_url in (Config.VK_ADS_OVERVIEW_URL, Config.VK_ADS_REGISTER_URL))
