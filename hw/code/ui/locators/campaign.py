...
class CampaignMenuLocators:
    ...
    FIRST_CAMPAIGN_HEADER = (By.XPATH, '//h2[contains(@class, "vkuiPlaceholder__header") and contains(text(), "Создайте первую рекламную кампанию")]')

    CAMPAIGN_DROPDOWN_BUTTON = (By.XPATH, '//button[@data-testid="tags-selector" and .//span[text()="Все кампании"]]')
    DRAFTS_OPTION = (By.XPATH, '//div[contains(@class, "TagSelector_menuItem__yLaIs")]//span[@data-testid="drafts" and text()=" Черновики"]')
...
class CampaignSettingsLocators:
    ...
    CAMPAIGN_NAME_INPUT = (By.XPATH, '//h2[contains(@class, "EditableTitle_title__5fIJC") and contains(text(), "Кампания")]')
    ...
    BUDGET_SELECT = (By.XPATH, '//div[contains(@class, "vkuiCustomSelect") and @data-testid="budget"]')
    ...
    FREQUENCY_SETTINGS_CHECKBOX = (By.XPATH, '//div[@data-name="uniq_shows_limit"]//input[@type="checkbox"]')
    ...
    CONTINUE_BUTTON = (By.XPATH, '//button[contains(@class, "vkuiButton") and contains(text(), "Продолжить")]')
...
class GroupLocators:
    ...
    GROUP_DATES_LABEL = (By.XPATH, '//h2[contains(@class, "FormItem_top__A6tjT") and contains(.//span, "Даты проведения группы")]')
    ...
    SEARCH_TOOLTIP_NO_RESULTS = (By.XPATH, '//div[contains(@class, "Tooltip_tooltip__piez5") and @role="tooltip"]//span[text()="Введите поисковый запрос"]')
    ...
    YAROSLAVL_OPTION = (By.XPATH, '//div[@class="Branch_title__FvS4M" and .//span/b[text()="Ярославль"]]')
